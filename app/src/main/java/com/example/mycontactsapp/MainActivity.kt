...
class MainActivity : AppCompatActivity() {
    ...
    //  When I save new contact in DB then what should be contactId since
    //  that was generated by android's Contact DB (it will be Null
    //  so that when syncing i'll know that this was not added in android)
    //  How will I manage sync contact If I give dummyID or 0 as contactId
